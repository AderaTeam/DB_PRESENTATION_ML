...
from presentation_generator_service.src.constants import NLP_LIGHTFULL_MODEL
from comutators.get_topics_comutator import get_topics_comutator
...
def generate_presentation(body: GeneratePresentationBodyModel):
    texts = split_on_sub_texts(text=lematized_text)
